...
const RAW_THEMES: DawatTheme[] = [
  ...
  // ─── Premium themes (DAW-65) ─────────────────────────────────
  {
    id: 'ramadan_night',
    name: 'Ramadan Night',
    categories: ['Ramadan', 'Trending', 'Elegant'],
    bannerBg: '#060B1A',
    bannerBgImage: 'linear-gradient(180deg, #060B1A 0%, #0D1533 30%, #162050 60%, #0A0F28 100%)',
    accentColor: '#8B9FD4',
    textColor: '#D4DFFF',
    tagBg: '#162050',
    tagColor: '#8B9FD4',
    ...
    background: {
      type: 'gradient',
      stops: ['#060B1A', '#0D1533', '#162050', '#0A0F28'],
      angle: 180,
      pattern: 'arabesque',
      overlayOpacity: 0.06,
    },
    typography: { titleFont: 'ManropeLight', titleLetterSpacing: 1.5 },
    accents: { primary: '#8B9FD4', secondary: 'rgba(139, 159, 212, 0.25)', onAccent: '#060B1A' },
    surface: {
      bg: 'rgba(13, 21, 51, 0.55)',
      border: 'rgba(139, 159, 212, 0.12)',
      borderRadius: 22,
    },
  },
  {
    id: 'eid_gala',
    name: 'Eid Gala',
    categories: ['Eid', 'Trending', 'Elegant'],
    bannerBg: '#0D0A05',
    bannerBgImage: 'linear-gradient(135deg, #0D0A05 0%, #1A1408 25%, #2A1F0A 50%, #3A2A0F 75%, #1A1408 100%)',
    accentColor: '#FFD700',
    textColor: '#FFF8E7',
    tagBg: '#2A1F0A',
    tagColor: '#FFD700',
    ...
    background: {
      type: 'gradient',
      stops: ['#0D0A05', '#1A1408', '#2A1F0A', '#3A2A0F', '#1A1408'],
      angle: 135,
      pattern: 'geometric-stars',
      overlayOpacity: 0.08,
    },
    typography: { titleFont: 'ManropeExtraBold', titleLetterSpacing: -0.5 },
    accents: { primary: '#FFD700', secondary: 'rgba(255, 215, 0, 0.20)', onAccent: '#0D0A05' },
    surface: {
      bg: 'rgba(26, 20, 8, 0.65)',
  ...
  },
  {
    id: 'sisters_dreamy',
    name: 'Sisters Dreamy',
    categories: ['Sisters', 'Trending', 'Elegant'],
    bannerBg: '#FBF0F5',
    bannerBgImage: 'linear-gradient(180deg, #FBF0F5 0%, #F0D8E8 30%, #E8C8DD 60%, #F5E0EE 100%)',
    accentColor: '#C45A8A',
    textColor: '#3A1428',
    tagBg: '#F0D8E8',
    tagColor: '#C45A8A',
    ...
    background: {
      type: 'gradient',
      stops: ['#FBF0F5', '#F0D8E8', '#E8C8DD', '#F5E0EE'],
      angle: 180,
      pattern: 'arabesque',
      overlayOpacity: 0.04,
    },
    typography: { titleFont: 'ManropeSemiBold', titleLetterSpacing: 0.3 },
    accents: { primary: '#C45A8A', secondary: 'rgba(196, 90, 138, 0.20)', onAccent: '#FFFFFF' },
    surface: {
      bg: 'rgba(255, 255, 255, 0.55)',
      border: 'rgba(196, 90, 138, 0.15)',
      borderRadius: 22,
    },
  },
];
